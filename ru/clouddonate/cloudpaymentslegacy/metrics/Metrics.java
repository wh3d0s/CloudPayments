...
public class Metrics {
    ...
    private int getPlayerAmount() {
        try {
            ...
            try {
                ...
                Object players = onlinePlayersMethod.invoke(null);
                if (players instanceof Collection) {
                    return ((Collection<?>) players).size();
                } else {
    ...
    public static class JsonObjectBuilder {
        ...
        private static String escape(String value) {
            ...
            for (int i = 0; i < value.length(); i++) {
                ...
                else if (c <= 0xF) builder.append("\\u000").append(Integer.toHexString(c));
                else if (c <= 0x1F) builder.append("\\u00").append(Integer.toHexString(c));
    ...
    public static class MetricsBase {
        ...
        private void submitData() {
            final JsonObjectBuilder.JsonObject data;
            try {
                ...
                data = baseJsonBuilder.build();
            } catch (Exception e) {
                if (logErrors) errorLogger.accept("Failed to build bStats metrics data", e);
                return;
            }
        ...
        private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
            ...
            String urlStr = String.format(REPORT_URL, platform);
        ...
        private void checkRelocation() {
            if (System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
                ...
                String packageName = MetricsBase.class.getPackage().getName();
